...
//		}
//	};
//	private final static List<ShapePart> shapePartArray = Lists.newArrayList();

//	private final static Matrix4f idt = new Matrix4f();
//	private final static Matrix4f tmpM = new Matrix4f();
//
...
//	}
//
//	public static btCollisionShape obtainStaticShape (final List<ShapePart> parts) {
//		if (parts.size() == 0) return null;
//		if (parts.size() == 1 &&  parts.get(0).equals(idt))
...
//
//			result.addChildShape(new Matrix4f(parts.get(i).transform),shape);//parts.get(i).transform, shape);
//			shape.release();
//		}
//		return result;
//	}
